...
JNIEXPORT jlong JNICALL Java_org_sleuthkit_datamodel_SleuthkitJNI_openImgNatDigi
  (JNIEnv *, jclass, jobjectArray, jint);

JNIEXPORT jlong JNICALL Java_org_sleuthkit_datamodel_SleuthkitJNI_appendImgNat
